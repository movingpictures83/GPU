...
int main(int argc, char **argv) {
  ...
  for (i = 0; i < 4; i++) {
    ...
    gpuTKCheck(cudaMalloc((void **)&d_A[i], (4*Seglen+inputLength) * sizeof(float)));
    gpuTKCheck(cudaMalloc((void **)&d_B[i], (4*Seglen+inputLength) * sizeof(float)));
    gpuTKCheck(cudaMalloc((void **)&d_C[i], (4*Seglen+inputLength) * sizeof(float)));
  }
